...
func WithLogging(inner k8s_io_client_go_kubernetes_typed_rbac_v1.RbacV1Interface, logger logr.Logger) k8s_io_client_go_kubernetes_typed_rbac_v1.RbacV1Interface {
...
func (c *withLogging) ClusterRoleBindings() k8s_io_client_go_kubernetes_typed_rbac_v1.ClusterRoleBindingInterface {
	return clusterrolebindings.WithLogging(c.inner.ClusterRoleBindings(), c.logger.WithValues("resource", "ClusterRoleBindings"))
}
func (c *withLogging) ClusterRoles() k8s_io_client_go_kubernetes_typed_rbac_v1.ClusterRoleInterface {
	return clusterroles.WithLogging(c.inner.ClusterRoles(), c.logger.WithValues("resource", "ClusterRoles"))
}
func (c *withLogging) RoleBindings(namespace string) k8s_io_client_go_kubernetes_typed_rbac_v1.RoleBindingInterface {
...
func (c *withLogging) Roles(namespace string) k8s_io_client_go_kubernetes_typed_rbac_v1.RoleInterface {
