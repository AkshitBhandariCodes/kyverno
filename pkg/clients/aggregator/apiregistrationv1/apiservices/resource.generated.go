...
import (
	...
	k8s_io_kube_aggregator_pkg_client_applyconfiguration_apiregistration_v1 "k8s.io/kube-aggregator/pkg/client/applyconfiguration/apiregistration/v1"
...
func (c *withLogging) Apply(arg0 context.Context, arg1 *k8s_io_kube_aggregator_pkg_client_applyconfiguration_apiregistration_v1.APIServiceApplyConfiguration, arg2 k8s_io_apimachinery_pkg_apis_meta_v1.ApplyOptions) (*k8s_io_kube_aggregator_pkg_apis_apiregistration_v1.APIService, error) {
	start := time.Now()
...
func (c *withLogging) ApplyStatus(arg0 context.Context, arg1 *k8s_io_kube_aggregator_pkg_client_applyconfiguration_apiregistration_v1.APIServiceApplyConfiguration, arg2 k8s_io_apimachinery_pkg_apis_meta_v1.ApplyOptions) (*k8s_io_kube_aggregator_pkg_apis_apiregistration_v1.APIService, error) {
	start := time.Now()
...
func (c *withMetrics) Apply(arg0 context.Context, arg1 *k8s_io_kube_aggregator_pkg_client_applyconfiguration_apiregistration_v1.APIServiceApplyConfiguration, arg2 k8s_io_apimachinery_pkg_apis_meta_v1.ApplyOptions) (*k8s_io_kube_aggregator_pkg_apis_apiregistration_v1.APIService, error) {
	defer c.recorder.RecordWithContext(arg0, "apply")
	return c.inner.Apply(arg0, arg1, arg2)
}
func (c *withMetrics) ApplyStatus(arg0 context.Context, arg1 *k8s_io_kube_aggregator_pkg_client_applyconfiguration_apiregistration_v1.APIServiceApplyConfiguration, arg2 k8s_io_apimachinery_pkg_apis_meta_v1.ApplyOptions) (*k8s_io_kube_aggregator_pkg_apis_apiregistration_v1.APIService, error) {
...
func (c *withTracing) Apply(arg0 context.Context, arg1 *k8s_io_kube_aggregator_pkg_client_applyconfiguration_apiregistration_v1.APIServiceApplyConfiguration, arg2 k8s_io_apimachinery_pkg_apis_meta_v1.ApplyOptions) (*k8s_io_kube_aggregator_pkg_apis_apiregistration_v1.APIService, error) {
	var span trace.Span
...
func (c *withTracing) ApplyStatus(arg0 context.Context, arg1 *k8s_io_kube_aggregator_pkg_client_applyconfiguration_apiregistration_v1.APIServiceApplyConfiguration, arg2 k8s_io_apimachinery_pkg_apis_meta_v1.ApplyOptions) (*k8s_io_kube_aggregator_pkg_apis_apiregistration_v1.APIService, error) {
	var span trace.Span
	if tracing.IsInSpan(arg0) {
		arg0, span = tracing.StartChildSpan(
			arg0,
