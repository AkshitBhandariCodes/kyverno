...
func Evaluate(ctx context.Context, ivpols []*CompiledImageValidatingPolicy, request interface{}, admissionAttr admission.Attributes, namespace runtime.Object, lister corev1listers.SecretLister, authOpts []remote.Option, nameOpts []name.Option) (map[string]*EvaluationResult, error) {
